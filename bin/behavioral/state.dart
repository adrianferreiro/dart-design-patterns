// ! Patrón State en Dart
// Este patrón permite cambiar el comportamiento de un objeto cuando su estado interno cambia
// Es útil cuando el objeto necesita reaccionar diferente según su estado actual
